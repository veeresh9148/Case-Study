	         ...
	         <tr>
			  <td align="right" class="mainLabel" >
			                <table width="85%" border="2" cellspacing="2" cellpadding="2"
			  			    ...
			  			    <tr>
			                    <td class="tblDataText" >&nbsp;<Link to="/CompletedViewServiceRequest" id="CompletedViewServiceRequest"> 111111</Link> </td>
			                ...
			                <tr>
			                    ...
			                    <td class="tblDataText" >&nbsp; <Link to="/CancelledViewServiceRequest" id="CancelledViewServiceRequest"> 222222</Link></td>
			                ...
			                <tr>
			                    ...
			                    <td class="tblDataText" >&nbsp; <Link to="/RejectedViewServiceRequest" id="RejectedViewServiceRequest"> 333333</Link></td>
			                ...
			                <tr>
			                    ...
			                    <td class="tblDataText" >&nbsp;<Link to="/AssignedViewServiceRequest" id="AssignedViewServiceRequest">444444</Link> </td>
			                    <td class="tblDataText" >&nbsp; Job Request </td>
			                    <td class="tblDataText" >&nbsp; 30/05/2022</td>
			                    <td class="tblDataText" >&nbsp; 30/05/2022</td>
			                    <td class="tblDataText" >&nbsp; 30/05/2022</td>
			                ...
			                <tr>
			                    ...
			                    <td class="tblDataText" >&nbsp;<Link to="/RequestedViewServiceRequest" id="RequestedViewServiceRequest">555555</Link> </td>
			                    <td class="tblDataText" >&nbsp; Job Request </td>
			                    <td class="tblDataText" >&nbsp; 30/05/2022</td>
			                    <td class="tblDataText" >&nbsp; </td>
			                    <td class="tblDataText" >&nbsp; </td>
